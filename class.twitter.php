...
class twitter{
	 ...
	 * @var string
	 */
	var $user_agent='WP Twitter Image Host <michael@atastypixel.com>';
	 ...
	 * @var array
	 */
	var $headers=array('Expect:', 'X-Twitter-Client: ' => 'Twitter Image Host for Wordpress', 'X-Twitter-Client-Version: ' => 0.1,'X-Twitter-Client-URL: ' => 'http://atastypixel.com/blog/wordpress/plugins/twitter-image-host');
